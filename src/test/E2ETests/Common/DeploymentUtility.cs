...
namespace E2ETests
{
    ...
    {
        private static string APP_RELATIVE_PATH = Path.Combine("..", "..", "src", "Hooli");
            ...
            else
            {
                ...
                if (startParameters.PublishApplicationBeforeStart)
                {
                        ...
                        startParameters.ServerType == ServerType.IIS)
                    {
                        ...
                        var overrideConfig = Path.Combine(startParameters.ApplicationPath, "..", "approot", "src", "Hooli", "configoverride.json");
        ...
        private static void DnuPublish(StartParameters startParameters, ILogger logger, string publishRoot = null)
        {
            ...
            startParameters.ApplicationPath =
                ...
                Path.Combine(startParameters.PublishedApplicationRootPath, "approot", "src", "Hooli");
